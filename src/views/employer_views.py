...
@employers.route('/company/jobs/<employer_id>', methods=['GET'])
...
@employers.route('/company/job_applications/<job_id>', methods=['GET'])
...
@employers.route('/company/update_application_status', methods=['POST'])
...
@employers.route('/company/dashboard/<employer_id>', methods=['GET'])
